...
export type Testimonial = { q: string; who: string; sub: string };
...
export type PortfolioItem = {
	id: 'saj' | 'esan' | 'luxus' | 'booking' | 'analytics';
	name: string;
	url: string;
...
export const PORTFOLIO: PortfolioItem[] = [
	...
	},
	{
		...
		desc: {
			...
			en: 'Upholstery business site — gallery, services, contact.'
		},
	...
	},
	{
		...
		desc: {
			...
			en: 'Wellness store, courses and bookings.'
		},
		palette: ['#A57FB8', '#6B4C82', '#1F1729', '#F2EAF5']
	},
	{
		id: 'booking',
		name: 'booking.junttila.dev',
		url: 'booking.junttila.dev',
		tag: { fi: 'Oma työkalu', en: 'My own tool' },
		year: '2024',
		desc: {
			fi: 'Itse rakennettu ajanvarausjärjestelmä, käytössä useilla asiakkailla.',
			en: 'Self-built booking platform powering several client sites.'
		},
		palette: ['#5B8DEF', '#3A6DC8', '#0E1A33', '#E4ECFB']
	},
	{
		id: 'analytics',
		...
		palette: ['#1F1B16', '#E8C77A', '#3A332A', '#F5EFE2']
	}
];
